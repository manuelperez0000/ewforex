...
<html lang="en">
  ...
  <body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.php">Home <?php echo $sesion;?></a>
			...
			<p class="titulo">Iniciar Session</p>
				<form action="login.php" method="post">
				  ...
				  <div class="form-group">
					...
					<input name="pass" type="password" class="form-control" id="pass" aria-describedby="passwordHelp" placeholder="Password">
				  </div>
				  <input value="Ingresar" type="submit" class="btn btn-success"></input>
				  <a class="link_oscuro" href="">Olvide mi clave</a>
				</form>
